...
[![Tests](https://img.shields.io/badge/tests-4%2C017%20passing-brightgreen.svg)](#)
...
docker compose up        # start all 11 services
```
...
| [docs/threat-model.md](docs/threat-model.md) | The assistant's trust boundaries + accepted non-goals |
