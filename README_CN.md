...
**当前版本：** v0.8.0 — 画布、四个框架适配器和 Langfuse 可观测性已完成。
...
| 推理 | 提示输入 → 答案输出 | 世界模型 · 信念 · 假设 · VOI 门控证据 |
| 控制 | 无 | 5 层解析器 · NORMAL / CAUTIOUS / BLOCKED |
...
| 阶段 | 名称 | 重点 |
|---|---|---|
| **P0** *(进行中)* | 基础与状态架构 | FlowSpec 扩展、线束状态模型、`generation_id`、`completeness_flags`、健康向量 |
...
| **P5** | 执行与验证 | 预执行审查门控、9 层验证、对抗性通过、可逆性策略 |
