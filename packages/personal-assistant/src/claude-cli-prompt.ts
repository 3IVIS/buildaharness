 ...
 * (```json ... ```). Every caller (classifyTurnIntent, checkForContradictions,
 * reframeTaskDescriptionWithLLM, buildPlanFromTemplate, review-checker.ts, trust-tagging.ts,
 * failure-mode-matcher.ts) does a
