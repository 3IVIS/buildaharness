...
| Metric | Count | Source |
|---|---|---|
| Frontend tests (vitest) | 1497 across 94 files | `npm test` (root — aggregates src/ and every packages/* workspace) |
| Adapter tests (pytest) | 943 | `pytest adapter/tests/ -v` |
| MAF adapter tests | 42 | `pytest adapter/tests/test_maf_adapter.py -v` |
| Project-wide tests | 2,440 | pytest + vitest combined |
