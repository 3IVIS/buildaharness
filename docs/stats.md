...
| Metric | Count | Source |
|---|---|---|
| Frontend tests (vitest) | 1844 across 116 files | `npm test` (root — aggregates src/ and every packages/* workspace) |
| Adapter tests (pytest) | 1100 | `pytest adapter/tests/ -v` |
| MAF adapter tests | 42 | `pytest adapter/tests/test_maf_adapter.py -v` |
| Project-wide tests | 2,944 | pytest + vitest combined |
