...
- **Verdict:** Worse results, at higher cost — The candidate regressed a gating metric (taskSuccessRate, hallucinationRate, overconfidentWrongRate) beyond its CI band — the feature makes outcomes worse on its own stress slice.
...
|---|---|---|---|---|---|
| taskSuccessRate | 0.75 | 0.4167 | -0.3333 | ±0.0817 | regressed |
| hallucinationRate | 0 | 0.125 | 0.125 | ±0 | regressed |
| unauthorizedEffectRate | 0 | 0 | 0 | ±0 | — |
| recoveryRate | — | — | — | ±— | — |
| overconfidentWrongRate | 0 | 0.5833 | 0.5833 | ±0.1987 | regressed |
