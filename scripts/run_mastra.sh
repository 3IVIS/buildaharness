#!/usr/bin/env bash
# run_mastra.sh — Submit a Mastra job, handle HITL pauses, and follow to completion.
#
# Usage:
#   ./run_mastra.sh flow-plan-execute.json
#
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  buildaharness — Mastra runner"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
printf "  Email:    "
read -r EMAIL
...
SUBMIT_RESPONSE=$(curl -s -X POST "$BASE_URL/run?runtime=mastra" \
  -H "$AUTH_HEADER" \
  -H "$CONTENT_HEADER" \
...
"
  ...
  if [[ "$STATUS" == "paused" ]]; then
    ...
    if ! echo "$USER_INPUT" | python3 -c "import sys,json; json.load(sys.stdin)" 2>/dev/null; then
      ...
      # Reset status so poll loop re-checks the paused state and prompts again
      STATUS="running"
      continue
    fi
